...
<head>
    ...
    <script type="text/javascript">
    	$(function () {
    		...
    		//Modify버튼클릭시 admin 등급변경
    		$('#btnProfileModify').on('click', function (e) {
    			e.preventDefault();
    			var admin = $(":input:radio[name=Admin]:checked").val();
    			var userid = $('#userid').val();
    			//alert('Admin value: '+st);
    			location.href = '${path}/member/adminChange?userid=${resultUser.userid}&admin='+admin;
					...
					<!-- name -->
		              ...
		              <label class="block text-sm">
		                ...
		                <c:if test="${resultUser.emailauth eq '0' }">
		                	<span class="text-gray-700 dark:text-gray-400" style="color: red; font-size: 5">Unverified</span>
		                </c:if>
		                <c:if test="${resultUser.emailauth eq '1' }">
		                	<span class="text-gray-700 dark:text-gray-400" style="color: blue; font-size: 5">Verified</span>
		                </c:if>
		                ...
		                <div class="mt-2">
		                  ...
		                  <label class="inline-flex items-center text-gray-600 dark:text-gray-400" >
		                    <input type="radio" class="text-purple-600 form-radio focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
		                      name="Admin" id="Admin" value="0" ${resultUser.admin eq '0'? 'checked':'' }/> &nbsp; <span class="ml-2">관리자</span>
		                  </label>
		                  
		                  <label class="inline-flex items-center text-gray-600 dark:text-gray-400" >
		                    <input type="radio" class="text-purple-600 form-radio focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
		                      name="Admin" id="Admin" value="1" ${resultUser.admin eq '1'? 'checked':'' }/>  &nbsp; <span class="ml-2">강사</span>
		                  </label>
		                  
		                  <label class="inline-flex items-center text-gray-600 dark:text-gray-400" >
		                    <input type="radio" class="text-purple-600 form-radio focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
		                      name="Admin" id="Admin" value="2" ${resultUser.admin eq '2'? 'checked':'' }/>  &nbsp; <span class="ml-2">회원</span>
		                  </label>
